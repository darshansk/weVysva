...
class MeetingPopUpViewController: UIViewController {
    ...
    @IBAction func cancelButtonIsClicked(_ sender: Any) {
        dismiss(animated: true, completion: nil)
    }
    @IBAction func okayButtonClicked(_ sender: Any) {
       
               let storyBoard: UIStoryboard = UIStoryboard(name:"MeetingDates", bundle: nil)
               let newViewController = storyBoard.instantiateViewController(withIdentifier:"addMeetingDateViewController") as! AddMeetingDateViewController
