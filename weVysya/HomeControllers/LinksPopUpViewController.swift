...
import Alamofire
import SwiftyJSON
public var selectedAppHouse: String = ""
public var stateFlag: Bool = false
public var loadFlag: Bool = false
class LinksPopUpViewController: UIViewController, UITextFieldDelegate {
...
pageNavigation()
    ...
    func pageNavigation(){
        ...
        let newViewController = storyBoard.instantiateViewController(withIdentifier:"linksViewController") as! LinkViewController
